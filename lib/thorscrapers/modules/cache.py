...
from thorscrapers.modules.control import existsPath, dataPath, makeFile, cacheFile
...
import xbmc
from thorscrapers.modules.control import joinPath, transPath, addonInfo, existsPath, makeFile
